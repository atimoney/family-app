...
type TasksResourceLabelProps = {
  arg: ResourceLabelContentArg;
};

/**
 * Resource label content renderer for Tasks Family View (member columns)
 */
export function TasksResourceLabel({ arg }: TasksResourceLabelProps) {
